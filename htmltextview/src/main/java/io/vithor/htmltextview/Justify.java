...
/**
 * Created by Vithorio Polten on 19/09/16.
 */
...
class Justify {
    ...
    static void setupScaleSpans(final @NotNull Justified justified,
        ...
        for (int line = 0; line < count; ++line) {
            ...
            // Don't justify when there's already another alignment.
            if (spannable.getSpans(lineStart, lineEnd - 1, AlignmentSpan.class).length != 0) continue;
